...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(291, 20), S(344, 69), S(294, 96), S(219,105) },
   { S(289, 63), S(329,113), S(263,165), S(205,154) },
   { S(226,102), S(271,159), S(202,191), S(136,188) },
   { S(204,124), S(212,189), S(175,191), S(137,201) },
   { S(177,125), S(205,182), S(143,221), S( 94,226) },
   { S(147,111), S(188,172), S(113,195), S( 70,194) },
   { S(116, 65), S(158,115), S( 93,137), S( 48,156) },
   { S( 94, 22), S(120, 69), S( 78, 94), S( 31,104) }
  }
};
