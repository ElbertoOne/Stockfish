...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(291, 13), S(344, 62), S(294, 89), S(219, 98) },
   { S(289, 56), S(329,107), S(263,160), S(205,149) },
   { S(226, 95), S(271,154), S(202,187), S(136,185) },
   { S(204,117), S(212,184), S(175,188), S(137,198) },
   { S(177,118), S(205,177), S(143,218), S( 94,225) },
   { S(147,104), S(188,166), S(113,191), S( 70,191) },
   { S(116, 58), S(158,109), S( 93,132), S( 48,151) },
   { S( 94, 15), S(120, 62), S( 78, 87), S( 31, 97) }
  }
};
