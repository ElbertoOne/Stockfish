...
#undef S
  ...
  private:
    ...
    Score initiative(Value eg, int16_t imbalance) const;
  ...
  template<Tracing T>
  Score Evaluation<T>::initiative(Value eg, int16_t imbalance) const {
  ...
  Value Evaluation<T>::value() {
    ...
    score += initiative(eg_value(score), me->value);
