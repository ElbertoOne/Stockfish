...
namespace {
  ...
  const Score MobilityBonus[4][32] = {
    { S(-75,-76), S(-57,-53), S(-10,-29), S( -4,-10), S(  6,  5), S( 14, 12), // Knights
      S( 22, 27), S( 29, 29), S( 35, 29) },
    { S(-47,-59), S(-20,-23), S( 14, -3), S( 27, 13), S( 39, 24), S( 51, 43), // Bishops
      S( 56, 52), S( 63, 57), S( 63, 65), S( 69, 73), S( 82, 78), S( 82, 85),
      S( 92, 89), S( 98, 98) },
    { S(-58,-76), S(-27,-18), S(-15, 28), S(-10, 55), S( -5, 69), S( -2, 82), // Rooks
      S(  9,112), S( 16,118), S( 30,132), S( 29,142), S( 32,155), S( 38,165),
      S( 46,166), S( 48,169), S( 58,171) },
    { S(-39,-36), S(-22,-15), S(  4,  8), S(  3, 17), S( 13, 34), S( 20, 54), // Queens
      S( 30, 61), S( 40, 72), S( 43, 80), S( 48, 91), S( 55, 94), S( 60,105),
      S( 60,113), S( 66,120), S( 66,124), S( 71,125), S( 72,134), S( 72,137),
      S( 78,140), S( 87,141), S( 88,148), S(100,167), S(103,170), S(103,175),
      S(106,184), S(108,189), S(114,206), S(116,212) }
  };
  ...
  const Score Protector[4][8] = {
    { S(0, 0), S( 7, 9), S( 7, 1), S( 1, 5), S( -9,-5), S( -1,-3), S( -7,-3), S(-17,-11) }, // Knight
    { S(0, 0), S(11, 8), S(-7,-1), S(-2,-2), S( -1,-7), S(-11,-4), S( -10,-1), S(-15, -1) }, // Bishop
    { S(0, 0), S(10, 0), S(-2, 2), S(-6, 4), S( -6, 2), S(-14,-3), S( -3,-8), S(-12, -7) }, // Rook
