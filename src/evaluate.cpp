...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    {}, {},
    { S(-83,-85), S(-69,-59), S( -21,-8), S( -2,10), S( 17, -1), S( 23, 26), // Knights
      S( 38, 26), S( 38, 40), S( 46, 38) },
    { S(-42,-69), S(-16,-44), S( 17,-13), S( 27, 18), S( 38, 31), S( 51, 45), // Bishops
      S( 57, 63), S( 73, 53), S( 57, 81), S( 58, 91), S( 95, 94), S( 77, 81),
      S( 80, 65), S(116,117) },
    { S(-85,-72), S(-42,-19), S(-11, 30), S(-15, 64), S(  5, 65), S(  3, 92), // Rooks
      S( 20,105), S( 27,124), S( 42,140), S( 40,143), S( 40,162), S( 35,185),
      S( 53,184), S( 50,162), S( 51,177) },
    { S(-45,-24), S(-11,-20), S(  1, 18), S( -5, 14), S( 11, -1), S( 14, 49), // Queens
      S( 49, 60), S( 47, 51), S( 43, 85), S( 52,117), S( 68, 86), S( 86,113),
      S( 47,101), S( 78,116), S( 68,124), S( 74,125), S( 87,135), S( 81,134),
      S( 87,133), S( 99,138), S( 87,140), S(111,148), S(139,167), S(108,181),
      S(118,157), S(133,194), S(137,201), S(145,190) }
  };
